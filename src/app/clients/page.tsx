          ...
          <div className="lg:col-span-2 bg-slate-900/30 border border-slate-900 rounded-xl p-6 space-y-4">
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                className="px-3.5 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold rounded border border-slate-700 transition-all cursor-pointer"
              >
                + Tambah Klien
              </button>
            </div>
                    ...
                    {clients.map((client) => {
                      ...
                      return (
                        <tr
                          ...
                          className={`cursor-pointer hover:bg-slate-900/25 transition-all ${
